...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    test_volume_of_cube = volume_of_cube(4 )
    assert_equal(64 , test_volume_of_cube)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    test_volume_of_sphere = volume_of_sphere(2)
    assert_equal(33.510321638291124 ,test_volume_of_sphere)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    test_fahrenheit_to_celsius = fahrenheit_to_celsius (68)
    assert_equal(20 ,test_fahrenheit_to_celsius)
  end
